 ...
 *
 * Responses should be considered immutable; all methods that might change state are
 * implemented such that they retain the internal state of the current
 * message and return a new instance that contains the changed state.
 *
 * However, to retain backwards compatibility, this object provides a number of methods
 * that mutate objects in-place. These methods are deprecated, and will be removed
 * in 4.0.0
 */
